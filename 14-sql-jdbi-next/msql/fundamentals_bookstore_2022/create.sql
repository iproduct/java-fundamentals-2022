...
INSERT INTO `fundamentals_bookstore_2022`.`users` (`firstName`, `lastName`, `age`, `username`, `password`, `role`,
                                                   `active`)
VALUES ('Deafult', 'Admin', '1', 'admin', 'Admin123#', 'ADMIN', b'1');
INSERT INTO `fundamentals_bookstore_2022`.`users` (`firstName`, `lastName`, `age`, `username`, `password`, `role`,
                                                   `active`)
VALUES ('Default', 'Author', '1', 'author', 'Author123#', 'AUTHOR', b'1');
INSERT INTO `fundamentals_bookstore_2022`.`users` (`firstName`, `lastName`, `age`, `phone`, `username`, `password`,
                                                   `role`, `active`)
